...
def zigzag_points(rows, cols):
    ...
    # similar to switch case and provides the next point of traversal
...
def metric(df,original_img,compressed_img,imageName):

    # opened the original image
    ref_img=cv2.imread(original_img)

    # opened compressed image
    comp_img=cv2.imread(compressed_img)
